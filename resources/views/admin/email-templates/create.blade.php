...
@section('titolo', 'Nuovo Email Template')
...
<div class="p-6">
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Crea Nuovo Email Template</h2>
            <p class="text-gray-600 mt-1">Compila tutti i campi obbligatori</p>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.email-templates.store') }}" class="bg-white rounded-lg shadow p-6">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="codice" value="{{ old('codice') }}" required
                    ...
                    <div>
                        ...
                        <select name="tipo" required
                            ...
                            @foreach($tipiDisponibili as $valore => $etichetta)
                                <option value="{{ $valore }}" {{ old('tipo') == $valore ? 'selected' : '' }}>
                                    {{ $etichetta }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="oggetto" value="{{ old('oggetto') }}" required
                    ...
                    <div>
                        ...
                        <textarea name="corpo_html" rows="15" required
                                  ...
                                  class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia font-mono text-sm @error('corpo_html') border-red-500 @enderror">{{ old('corpo_html') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="corpo_testo" rows="8"
                                  ...
                                  class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia font-mono text-sm @error('corpo_testo') border-red-500 @enderror">{{ old('corpo_testo') }}</textarea>
                        @error('corpo_testo')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <label class="inline-flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="{{ $codice }}"
                               {{ is_array(old('variabili_disponibili')) && in_array($codice, old('variabili_disponibili')) ? 'checked' : '' }}
            ...
            <div class="flex items-center gap-3 pt-6 border-t">
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Crea Template
                </button>
