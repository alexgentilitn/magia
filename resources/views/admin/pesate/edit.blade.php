...
@section('titolo', 'Modifica Pesata')
...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Modifica Pesata - {{ $cliente->nome }} {{ $cliente->cognome }}</h2>
        ...
        <form method="POST" action="{{ route('admin.clienti.pesate.update', [$cliente->id, $pesata->id]) }}">
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Aggiorna Pesata
                </button>
            </div>
