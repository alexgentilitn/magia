...
@section('titolo', 'Modifica Programma')
...
<div class="p-6">
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('admin.programmi.show', $programma->id) }}" class="text-fucsia-magia hover:text-viola-magia mb-2 inline-block">
                <i class="fas fa-arrow-left mr-2"></i> Torna al dettaglio
            </a>
            <h2 class="text-2xl font-bold text-gray-800">Modifica Programma</h2>
            <p class="text-gray-600 mt-1">{{ $programma->nome }}</p>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.programmi.update', $programma->id) }}" class="bg-white rounded-lg shadow p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="nome" value="{{ old('nome', $programma->nome) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $programma->slug) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="tipologia" required
                            ...
                            <option value="fitness" {{ old('tipologia', $programma->tipologia) == 'fitness' ? 'selected' : '' }}>Fitness</option>
                            <option value="danza" {{ old('tipologia', $programma->tipologia) == 'danza' ? 'selected' : '' }}>Danza</option>
                            <option value="alimentazione" {{ old('tipologia', $programma->tipologia) == 'alimentazione' ? 'selected' : '' }}>Alimentazione</option>
                            <option value="wellness" {{ old('tipologia', $programma->tipologia) == 'wellness' ? 'selected' : '' }}>Wellness</option>
                            <option value="personalizzato" {{ old('tipologia', $programma->tipologia) == 'personalizzato' ? 'selected' : '' }}>Personalizzato</option>
                            <option value="altro" {{ old('tipologia', $programma->tipologia) == 'altro' ? 'selected' : '' }}>Altro</option>
                        </select>
                        @error('tipologia')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="livello" required
                            ...
                            <option value="">Seleziona...</option>
                            <option value="principiante" {{ old('livello', $programma->livello) == 'principiante' ? 'selected' : '' }}>Principiante</option>
                            <option value="intermedio" {{ old('livello', $programma->livello) == 'intermedio' ? 'selected' : '' }}>Intermedio</option>
                            <option value="avanzato" {{ old('livello', $programma->livello) == 'avanzato' ? 'selected' : '' }}>Avanzato</option>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="durata_giorni" value="{{ old('durata_giorni', $programma->durata_giorni) }}" min="1"
                               placeholder="30"
                    ...
                    <div>
                        ...
                        <input type="number" name="durata_mesi" value="{{ old('durata_mesi', $programma->durata_mesi) }}" min="1"
                               placeholder="3"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Lezioni Totali</label>
                        <input type="number" name="lezioni_totali" value="{{ old('lezioni_totali', $programma->lezioni_totali) }}" min="1"
                               placeholder="24"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Lezioni a Settimana</label>
                        <input type="number" name="lezioni_settimana" value="{{ old('lezioni_settimana', $programma->lezioni_settimana) }}" min="1" max="7"
                               placeholder="2"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Durata Singola Lezione (min)</label>
                        <input type="number" name="durata_singola_lezione" value="{{ old('durata_singola_lezione', $programma->durata_singola_lezione) }}" min="15"
                               placeholder="60"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="prezzo_base" value="{{ old('prezzo_base', $programma->prezzo_base) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2.5 text-gray-500">€</span>
                            <input type="number" name="prezzo_promo" value="{{ old('prezzo_promo', $programma->prezzo_promo) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="promo_valida_da" value="{{ old('promo_valida_da', $programma->promo_valida_da?->format('Y-m-d')) }}"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Promo Valida A</label>
                        <input type="date" name="promo_valida_a" value="{{ old('promo_valida_a', $programma->promo_valida_a?->format('Y-m-d')) }}"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>                    <div class="md:col-span-2">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="prezzo_su_richiesta" value="1" {{ old('prezzo_su_richiesta', $programma->prezzo_su_richiesta) ? 'checked' : '' }}
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="posti_disponibili" value="{{ old('posti_disponibili', $programma->posti_disponibili) }}" min="1"
                               placeholder="20"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    ...
                    <div>
                        ...
                        <input type="number" name="min_partecipanti" value="{{ old('min_partecipanti', $programma->min_partecipanti) }}" min="1"
                               placeholder="5"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Max Partecipanti</label>
                        <input type="number" name="max_partecipanti" value="{{ old('max_partecipanti', $programma->max_partecipanti) }}" min="1"
                               placeholder="20"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div class="md:col-span-3">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="sempre_disponibile" value="1" {{ old('sempre_disponibile', $programma->sempre_disponibile) ? 'checked' : '' }}
                                   class="rounded text-fucsia-magia focus:ring-fucsia-magia">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="sede_id"
                            ...
                            <option value="{{ $sede->id }}" {{ old('sede_id', $programma->sede_id) == $sede->id ? 'selected' : '' }}>
                                {{ $sede->nome }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="professionista_id"
                            ...
                            <option value="{{ $professionista->id }}" {{ old('professionista_id', $programma->professionista_id) == $professionista->id ? 'selected' : '' }}>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="data_inizio" value="{{ old('data_inizio', $programma->data_inizio?->format('Y-m-d')) }}"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Data Fine</label>
                        <input type="date" name="data_fine" value="{{ old('data_fine', $programma->data_fine?->format('Y-m-d')) }}"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="attivo" value="1" {{ old('attivo', $programma->attivo) ? 'checked' : '' }}
                                   class="rounded text-fucsia-magia focus:ring-fucsia-magia">
                    ...
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="visibile_pubblico" value="1" {{ old('visibile_pubblico', $programma->visibile_pubblico) ? 'checked' : '' }}
                                   class="rounded text-fucsia-magia focus:ring-fucsia-magia">
                    ...
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="in_evidenza" value="1" {{ old('in_evidenza', $programma->in_evidenza) ? 'checked' : '' }}
                                   class="rounded text-fucsia-magia focus:ring-fucsia-magia">
                    ...
                    <div>
                        ...
                        <input type="number" name="ordine" value="{{ old('ordine', $programma->ordine) }}" min="0"
                               placeholder="0"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-fucsia-magia">
